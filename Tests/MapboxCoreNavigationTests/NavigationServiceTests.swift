...
class NavigationServiceTests: TestCase {
    ...
    func testStartIfNeverSimulation() {
        ...
        XCTAssertTrue(eventsManager.hasEvent(with: EventType.routeRetrieval.rawValue))
    ...
    func testStopIfNoSimulation() {
        ...
        XCTAssertFalse(eventsManager.hasEvent(with: EventType.cancel.rawValue))
    ...
    func testEndNavigationIfSimulation() {
        ...
        XCTAssertTrue(eventsManager.hasEvent(with: EventType.cancel.rawValue))
        XCTAssertTrue(locationManager.stopUpdatingHeadingCalled)
        XCTAssertTrue(locationManager.stopUpdatingLocationCalled)
    ...
    func testDidUpdate() {
        ...
        XCTAssertTrue(eventsManager.hasEvent(with: EventType.depart.rawValue))
