...
class PassiveLocationManagerTests: TestCase {
    ...
    func testHandleDidUpdateLocations() {
        ...
        XCTAssertTrue(eventsManagerSpy.hasEvent(with: EventType.freeDrive.rawValue))
    }
    ...
    func testUpdatedLocationIfSuccess() {
        ...
        XCTAssertFalse(eventsManagerSpy.hasEvent(with: EventType.freeDrive.rawValue), "Do not report navigation twice")
    }
