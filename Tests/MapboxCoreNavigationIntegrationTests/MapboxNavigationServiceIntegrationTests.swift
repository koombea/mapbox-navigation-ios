...
class MapboxNavigationServiceIntegrationTests: TestCase {
    ...
    func testTurnstileEventSentUponInitialization() {
        ...
        XCTAssertTrue(eventsManagerSpy.hasEvent(with: EventType.turnstile.rawValue))
    }
    ...
    func testReroutingFromLocationUpdatesSimulatedLocationSource() {
        ...
        XCTAssertTrue(eventsManagerSpy.hasEvent(with: EventType.routeRetrieval.rawValue))
    ...
    func testGeneratingAnArrivalEvent() {
        ...
        XCTAssertTrue(eventsManagerSpy.hasEvent(with: EventType.depart.rawValue))
